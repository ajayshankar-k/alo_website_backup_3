...
import WhatWe from '@/section/Home/what';
import AloEmployee from '@/section/Home/alo-employee';
import ZigZag from '@/section/Home/zig-zag';
import Slogan from '@/section/Home/slogan';
...
const Home = () => {
    return (
        <Fragment>
            <Head>
                <title>Alo Info-Tech - Harmonizing Technology, Empowering Individual </title>
