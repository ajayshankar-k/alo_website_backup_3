...
import Banner from '@/section/websiteDevelopment/Banner'
import YourGrowth from '@/section/websiteDevelopment/YourGrowth'
import WebDevServices from '@/section/websiteDevelopment/WebDevServices'
import Head from 'next/head'
import WebDevProcess from '@/section/websiteDevelopment/WebDevProcess'
...
const index = () => {
  return (
    <Fragment>
      <Head>
        <title>
          Alo Info-Tech - Website Development
        </title>
